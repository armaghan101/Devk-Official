    ...
    <>
      <main style={heroStyle} className="h-screen w-screen relative">
        ...
        <main className="h-[88%] w-screen flex justify-center items-center flex-col">
          <h3 className="hero-text text-7xl text-center text-white">
            We only teach what we are <br /> really really good at.
          </h3>
          <div className="bttns flex justify-center items-center gap-7 mt-10">
            <button className="h-15 bg-white rounded-full px-15 ">Get In Touch</button>
            <button className="h-15 rounded-full px-15 border-2 border-white text-white">Learn More</button>
          </div>
          <div className="experience flex justify-center items-center gap-10 mt-30 text-white text-xl">
