...
export default function Testimonials() {
  return (
    <section className="w-full opacity-0 translate-y-6 animate-fadeUp py-10 md:py-16">
        ...
        >
          {testimonials.map((t, index) => (
            <SwiperSlide key={index}>
              <div className="bg-gray-100 text-gray-800 rounded-2xl p-6 shadow-md flex flex-col justify-between min-h-[260px] md:min-h-[300px]
